...
public class RecommendFoodAdapter extends RecyclerView.Adapter<RecommendFoodAdapter.RecoommendViewHolder> {
    ...
    public RecommendFoodAdapter(List<Food> foods, IClickRecommendFood iClickRecommendFood) {
        this.foods = foods;
    ...
    public RecoommendViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RecoommendViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recommend_food,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecommendFoodAdapter.RecoommendViewHolder holder, int position) {
