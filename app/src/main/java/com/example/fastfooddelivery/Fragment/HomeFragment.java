...
public class HomeFragment extends Fragment {
    ...
    private List<Food> getListFood() {
        ...
        foods.add(new Food("food1",R.drawable.slide_1,"Mon 1",50000.0,false,1));
        foods.add(new Food("food2",R.drawable.slide_2,"Mon 2",40000.0,false,1));
        foods.add(new Food("food3",R.drawable.slide_3,"Mon 3",30000.0,false,1));
        foods.add(new Food("food4",R.drawable.slide_4,"Mon 4",80000.0,false,1));
